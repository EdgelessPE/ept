...
pub fn compute_hash_blake3(from_file: &str) -> Result<String> {
...
fn try_into_memmap_file(file: &File) -> Result<Option<memmap2::Mmap>> {
...
fn test_compute_hash_blake3() {
    let res = compute_hash_blake3("./examples/VSCode/VSCode/favicon.ico").unwrap();
    assert_eq!(
